...
function love.load()
    ...
    love.window.setTitle('Pong by Jerememetan')
    ...
    -- 1. 'start' (the beginning of the game, before first serve, change diffuculty)
...
function love.keypressed(key)
    ...
    elseif key == '1' then
        if gameState == 'start' then
            player1 = Paddle(player1.x, player1.y, 5, 80)     
        end
    elseif key == '2' then
        if gameState == 'start' then
            player1 = Paddle(player1.x, player1.y, 5, 50) 
        end
    elseif key == '3' then
        if gameState == 'start' then
            player1 = Paddle(player1.x, player1.y, 5, 20)
        end
    elseif key == '4' then
        if gameState == 'start' then
            player1 = Paddle(player1.x, player1.y, 5, 10)
        end 
...
function love.draw()
    ...
    if gameState == 'start' then
        ...
        love.graphics.printf('Press 1-4 to change your paddle size', 0, 20, VIRTUAL_WIDTH, 'center')
        love.graphics.printf('Press Enter to begin!', 0, 30, VIRTUAL_WIDTH, 'center')
        love.graphics.printf('Hold X = Autoplay', 0, 230, VIRTUAL_WIDTH, 'center')
    elseif gameState == 'serve' then
        -- UI messages
        love.graphics.setFont(smallFont)
